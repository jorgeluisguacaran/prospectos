...
class PlanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plan" do
    assert_difference('Plan.count') do
      post planes_url, params: { plan: { descripcion: @plan.descripcion, estatus: @plan.estatus } }
    end
  ...
  test "should update plan" do
    patch plan_url(@plan), params: { plan: { descripcion: @plan.descripcion, estatus: @plan.estatus } }
